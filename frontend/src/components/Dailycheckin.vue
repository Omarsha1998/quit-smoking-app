  ...
  >
    ...
    <q-card-section style="background: #faf2e4">
      ...
      <div v-if="todayLogged" class="text-center q-py-sm">
        ...
        >
          <template v-if="todaySmoked">
            ...
            {{
              todaySmokedCount > 0
                ? todaySmokedCount + ' cigarette' + (todaySmokedCount !== 1 ? 's' : '')
                : 'today'
            }}
            😔
          </template>
          <template v-else> You're smoke-free today! 🎉 </template>
        </div>
        ...
        <div
          v-if="todaySmoked && todaySmokedCount > 0 && cigarettesPerDay > 0"
          class="text-caption q-mt-xs"
          style="color: #c97a8a"
        >
          You avoided {{ Math.max(0, cigarettesPerDay - todaySmokedCount) }} out of
          {{ cigarettesPerDay }} today
        </div>
      </div>
      ...
      <div v-else-if="step === 2" class="text-center">
        ...
        <!-- Contextual feedback -->
        <div
          v-if="smokedCountInput > 0 && smokedCountInput > cigarettesPerDay"
        ...
        <div
          v-else-if="smokedCountInput > 0 && smokedCountInput < cigarettesPerDay"
          class="text-caption q-mb-sm"
          style="color: #5d9460"
        >
